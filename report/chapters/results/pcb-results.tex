...
\missingfigure{photo. Textual reference.}
...
result we where able to keep the bus as we originally inteded \todo{Making the
assumption that the third try will work..} but we lost all other IO
