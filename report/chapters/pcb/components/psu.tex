...
power supply, or place a reference to where it is located} The switch-mode gets 
...
\todo{insert something concrete here? ex: "such as 100uA"} can be challenging. 
...
\todo[inline]{Add reference to the USB specification.} This should suffice for normal operation.
