...
1.2V and 1.8V, and two current sensors.\todo[inline]{insert schematic drawing of
power supply or refer to it} The switch-mode gets an input voltage typically at
