...
\paragraph{Assignment Interpretation}
...
audio samples. For the rest of this report, we will refer to the MCU as the IO
controller and the FPGA as the audio accelerator \todo{make sure this is
actually the case}.
...
potential for energy efficiency, we aim to program our design and simulate
