...
The processor design has been kept as general as possible in order to make it easy to implement, relying on instructions to produce different output for each column of cores.\todo{mention something about the fourier transform here}
\newline
