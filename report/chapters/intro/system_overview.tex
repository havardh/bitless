...
\subsubsubsection{Micro USB} USB \todo{review, rewrite}

\subsubsubsection{Micro SD} SD-card \todo{review, rewrite}

\subsubsubsection{Minijacks} We added two jack channels, one for input and one for
...
\subsubsubsection{Buttons and LEDs} What's there to say.. They're
