...
Appendix~\ref{apx:schematics} (File: power\_supply.SchDoc).\todo{Refer to
...
http://www.usb.org/developers/docs/usb\_20\_070113.zip} \todo{reference to USB
specification.} This should suffice for normal operation. USB chargers will in
