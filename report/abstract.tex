...
is not limited to data level parallelization like a SIMD system would be.\todo{ok until this point, but the section has to be rewritten from this point.} With
